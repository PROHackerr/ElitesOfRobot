...
from ElitesOfRobot import LOGGER, dispatcher
from ElitesOfRobot.modules.sql import blacklist_url_sql as sql
...
__handlers__ = [
    ...
    ADD_URL_BLACKLIST_HANDLER, 
    RM_BLACKLIST_URL_HANDLER,
