...
from ElitesOfRobot.modules.helper_funcs.chat_status import ( bot_admin, user_admin,
                                                             is_user_admin, can_restrict )
        ...
        if is_user_admin(chat, user_id, member=member):
            ...
            message.reply_text(reply_msg,
                               reply_markup=InlineKeyboardMarkup(
                                    [
                                      [
                                        InlineKeyboardButton(text="Unmute", callback_data="muteb_mute={}".format(user_id)),
                                        InlineKeyboardButton(text="Delete", callback_data="del_{}=delete={}={}".format( chat.id, user_id,
                                                                                                                         message.reply_to_message.message_id ))
                                      ],
                                    [
                                        InlineKeyboardButton(text="Close", callback_data="mute_close")
                                    ]
                                  ]
                                ),
...
def muteb_callback(update, context):
    ...
    if not query.data == "mute_close":
        splitter = query.data.replace("del_", "").split("=")
