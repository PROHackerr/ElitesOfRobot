...
from ElitesOfRobot.modules.helper_funcs.chat_status import ( bot_admin, user_admin, can_delete,
                                                             is_user_ban_protected, can_restrict,
...
*Admin only:*
 ...
 - /dban <reply>: Ban a user by reply, and delete their message.
...
DBAN_HANDLER = CommandHandler("dban", dban, pass_args=True, filters=Filters.group)
TEMPBAN_HANDLER = CommandHandler(
    ["tban", "tempban"], temp_ban, pass_args=True, filters=Filters.group
)
DKICK_HANDLER = CommandHandler(["dkick", "dpunch"], dkick, pass_args=True, filters=Filters.group)
KICK_HANDLER = CommandHandler(["kick", "punch"], kick, pass_args=True, filters=Filters.group)
UNBAN_HANDLER = CommandHandler("unban", unban, pass_args=True, filters=Filters.group)
KICKME_HANDLER = DisableAbleCommandHandler(["kickme", "punchme"], kickme, filters=Filters.group)
