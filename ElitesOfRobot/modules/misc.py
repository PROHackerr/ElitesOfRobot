import os, html, requests, wikipedia
import random, re
...
from ElitesOfRobot import (OWNER_ID, SUDO_USERS, SUPPORT_USERS, 
                           WHITELIST_USERS, DEV_USERS,
                           spamwtc, dispatcher)
...
*More:*
 ...
 - /removebotkeyboard or /rmkeyboard: Got a nasty bot keyboard stuck in your group?
