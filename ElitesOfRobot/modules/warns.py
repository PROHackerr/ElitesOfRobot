...
from ElitesOfRobot import dispatcher, REDIS_AP, SUPPORT_CHAT 
...
def reply_filter(update, context) -> str:
    ...
    approve_list = list(REDIS_AP.sunion(f'approve_list_{chat_id}'))
...
def __stats__():
    return (
        "┣⊸ Overall Warns - {} ( {} )\n┋\n"
        "┣⊸ Warn Filters - {} ( {} )"
       f'\n┇ \n┖──⌊ <a href="https://t.me/ElitesOfLogs">Logs</a> • <a href="https://t.me/{SUPPORT_CHAT}">Support</a> ⌉ '.format(
            sql.num_warns(),
            sql.num_warn_chats(),
