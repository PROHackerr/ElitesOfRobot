...
from ElitesOfRobot.modules.helper_funcs.chat_status import (ADMIN_CACHE,
                                                            bot_admin,
                                                            can_promote,
                                                            user_admin,
                                                            can_pin,
...
from ElitesOfRobot.modules.helper_funcs.admin_rights import (user_can_changeinfo,
                                                             user_can_pin,
                                                             user_can_promote,
                                                            )
...
*Admin only:*
 ...
 - /admincache: Refresh chat admins.

*Note*: To set group sticker set chat must needs to have min 100 members.

An example of set group description:
`/setdes Hello, World`: this set group description.
"""

__mod_name__ = "Admin"

ADMIN_REFRESH_HANDLER = CommandHandler(["admincache", "reload_admins"], refresh_admin, filters=Filters.group)
