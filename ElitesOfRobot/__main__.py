...
from ElitesOfRobot import ( dispatcher, since_time_start, updater, TOKEN, OWNER_ID, 
                                                CERT_PATH, PORT, LOGGER, BLACKLIST_CHATS, WHITELIST_CHATS,
                                                SUPPORT_CHAT, WEBHOOK, URL, START_IMG, REPOSITORY )
...
def get_help(update, context):
    ...
    if chat.type != chat.PRIVATE:
           update.effective_message.reply_text(
               "Click The Button Below To Get Help Manu In Your PM.\n\nJoin Our [Support Chat](https://t.me/ElitesOfSupport) & [Discussion Chat](https://t.me/ElitesOfAnime) For More Information.",
               parse_mode=ParseMode.MARKDOWN,
               disable_web_page_preview=True,
               reply_markup=InlineKeyboardMarkup([[
                           InlineKeyboardButton(
